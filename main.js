...
import { OrbitControls } from "./nodemodules/three/examples/jsm/controls/OrbitControls.js"; //'three/examples/jsm/controls/OrbitControls.js';
...
import * as dat   from "./nodemodules/dat.gui/build/dat.gui.module.js";
...
function init() {
    ...
    let mesh;
    new GLTFLoader().load("assets/turtle.glb",
        function ( gltf ) {
